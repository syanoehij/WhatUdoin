...
```json
{
  "commands": [
    ...
    },
    {
      ...
      "returncode": 0,
      "stdout": "PASS {'supervisor_factory_uses_web_api_name': True, 'supervisor_factory_preserves_command': True, 'supervisor_factory_keeps_internal_env_together': True, 'supervisor_factory_protects_internal_env_from_extra_env': True, 'supervisor_sets_trusted_proxy': True, 'supervisor_sets_loopback_bind': True, 'supervisor_requires_front_router': True, 'main_supports_bind_host_env': True, 'app_direct_launcher_supports_bind_host_env': True, 'trusted_proxy_uses_xff': True, 'untrusted_direct_ignores_xff': True, 'internal_only_blocks_external_even_with_loopback_xff': True, 'internal_only_allows_loopback_router': True, 'default_runtime_not_changed': True, 'guard_missing_type_passthrough': True, 'guard_lifespan_passthrough': True}",
      "stderr": "",
      "passed": true
    }
  ],
