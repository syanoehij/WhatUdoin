...
| 2 | app.py: if _scheduler_service_enabled 블록에 finalize_expired_done 없음 | PASS | fin_in_enabled=False |
...
| 20 | app.py: check_upcoming_event_alarms는 else 분기 (단일프로세스 fallback)에만 등록 | PASS | SCHEDULER_SERVICE=1 환경에서 Web API에서 중복 등록 없음 |
