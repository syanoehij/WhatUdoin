...
**실행 시각**: 20260510T021712Z
**Python**: D:\Program Files\Python\Python312\python.exe
**Scheduler port**: 55529
**run_dir**: D:\Github\WhatUdoin\_workspace\perf\m3_4_live\runs\20260510T021712Z\supervisor_run

## 시나리오 결과

| # | 항목 | 결과 | 상세 |
|---|---|---|---|
| 1 | ensure_internal_token: path exists | PASS | D:\Github\WhatUdoin\_workspace\perf\m3_4_live\runs\20260510T021712Z\supervisor_run\internal_token |
...
| 6 | start_service: status=running | PASS | status=running, pid=46076 |
| 7 | healthz: 200 + status in {ok, starting} | PASS | status=ok error= |
| 8 | healthz: jobs_count >= 6 | PASS | jobs_count=6 |
| 9 | healthz: next_run_at 비어있지 않음 | PASS | next_run_at=2026-05-10T11:18:12.437800+09:00 |
| 10 | healthz: last_finalize_expired_done_at 채워짐 | PASS | last_finalize_expired_done_at=2026-05-10T02:17:12.443317+00:00 |
...
```json
{
  ...
  "service": "scheduler",
  "jobs_count": 6,
  "next_run_at": "2026-05-10T11:18:12.437800+09:00",
  "last_finalize_expired_done_at": "2026-05-10T02:17:12.443317+00:00",
  "uptime_seconds": 1
}
```
