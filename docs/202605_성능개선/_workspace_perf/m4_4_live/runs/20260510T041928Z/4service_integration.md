...
| 10 | ollama 포트 open 대기 | PASS | port=50666 |
| 11 | ollama probe_healthz PASS | PASS | status=ok error= |
| 12 | sse 포트 open 대기 | PASS | port=50667 |
| 13 | sse probe_healthz PASS | PASS | status=ok error= |
| 14 | sched 포트 open 대기 | PASS | port=50668 |
| 15 | sched probe_healthz PASS | PASS | status=ok error= |
| 16 | web_api mock: process alive | PASS | pid=43772 |
