...
- **다음 행동**: M2-18 완료. publisher.py logger + 카운터/메타 deque + healthz 3개 키, frontend realtime.js idle visibility/focus 재조회(60초 threshold + 5초 min interval). probe 17/17 + phase60 22/22 + phase59 25/25 PASS, phase54~58 회귀 PASS. 다음은 M2-19 Front Router SSE proxy 6종 조건.
